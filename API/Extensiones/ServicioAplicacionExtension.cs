...
using Data.Interfaces.Repositorio;
using Utilidades;
            ...
            services.AddSwaggerGen(options =>
            {
                options.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
                {
                    Description = "Ingresar Bearer [espacio] token \r\n\r\n" +
                                  "Ejemplo: Bearer ejokjnmlkjnmqwd051541644",
                    Name = "Authorization",
    ...
    {
        {
            ...
            var connectionString = config.GetConnectionString("SQL"); //Obtener el connetion string
            services.AddDbContext<AppDbContext>(option => option.UseSqlServer(connectionString)); //tomar la conexion y usar Sql Server
            services.AddCors();
            ...
            services.Configure<ApiBehaviorOptions>(options => 
            {
                ...
                {
                    var errores = actionContext.ModelState.Where(e => e.Value.Errors.Count > 0)
